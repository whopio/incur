...
| `include`     | `string[]` | Glob patterns for additional skill directories to include with all their resources. Use `'_root'` for the project-level SKILL.md and its references, scripts, assets, and agents directories |
