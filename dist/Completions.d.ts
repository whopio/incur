 ...
 */
export declare function complete(commands: Map<string, CommandEntry>, rootCommand: CommandEntry | undefined, argv: string[], index: number, globals?: GlobalsDescriptor | undefined): Candidate[];
/**
