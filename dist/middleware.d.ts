...
type InferGlobals<globals extends z.ZodObject<any> | undefined> = globals extends z.ZodObject<any> ? z.output<globals> : {};
/** Middleware handler that runs before/after command execution. */
export type Handler<vars extends z.ZodObject<any> | undefined = undefined, env extends z.ZodObject<any> | undefined = undefined, globals extends z.ZodObject<any> | undefined = undefined> = (context: Context<vars, env, globals>, next: () => Promise<void>) => Promise<void> | void;
...
export type Context<vars extends z.ZodObject<any> | undefined = undefined, env extends z.ZodObject<any> | undefined = undefined, globals extends z.ZodObject<any> | undefined = undefined> = {
...
export default function middleware<const vars extends z.ZodObject<any> | undefined = undefined, const env extends z.ZodObject<any> | undefined = undefined, const globals extends z.ZodObject<any> | undefined = undefined>(handler: Handler<vars, env, globals>): Handler<vars, env, globals>;
export {};
