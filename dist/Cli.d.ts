...
export declare namespace create {
    ...
    type Options<args extends z.ZodObject<any> | undefined = undefined, env extends z.ZodObject<any> | undefined = undefined, options extends z.ZodObject<any> | undefined = undefined, output extends z.ZodType | undefined = undefined, vars extends z.ZodObject<any> | undefined = undefined, globals extends z.ZodObject<any> | undefined = undefined> = {
         ...
         */
        banner?: (() => string | undefined | Promise<string | undefined>) | {
        ...
        globalAlias?: globals extends z.ZodObject<any> ? Partial<Record<keyof z.output<globals>, string>> : Record<string, string> | undefined;
    ...
    type UpdateOptions = {
        ...
        install?: ((context: UpdateInstallContext) => Promise<boolean | void> | boolean | void) | undefined;
...
type SkillCommandSource = Pick<CommandDefinition<any, any, any, any, any, any>, 'args' | 'description' | 'destructive' | 'env' | 'examples' | 'hint' | 'mcp' | 'options' | 'output'>;
